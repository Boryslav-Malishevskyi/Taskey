...
namespace Taskey
{
    internal class BaseDisplay : IDisplay
    {
        ...
        private event EventHandler<ActionParameters> onButtonClickInternal;

        event EventHandler<ActionParameters> IDisplay.OnButtonClick
        {
            add { onButtonClickInternal += value; }
            remove { onButtonClickInternal -= value; }
        }
        ...
        private void ControlPanelCreate()
        {
            ...
            CreateButton.Click += (x,y) => 
            {
                ...
                onButtonClickInternal?.Invoke(this, parameters);
            };
